  ...
  return (
    <div className="footer">
      <div className='ending'>
        <img src="./фото/logo.png" alt="" className='logotip' />
        ...
        <div className="contacts">
          ...
          <div className="number">
            <img src="./фото/Без имени 1.png" alt="" className='numb' />
            <div className="number-of-phone">0777161701</div>

          </div>
          <div className="email">
            <img src="./фото/Без имени 2.png" alt=""className='mail' />
            <div className='email-of-ender'>enderpro700@gmail.com</div>
          </div>
          <div className="locat">
            <img src="./фото/Без имени 4.png" alt=""className='local' />
